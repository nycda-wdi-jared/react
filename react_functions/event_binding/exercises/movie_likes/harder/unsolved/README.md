# React Event & HTML functions More Difficult Movie Exercise

* First, append 3 buttons of all of the users names from the array from the raters.js file
* Once that users name is clicked, it will display all of the movies and whether or not that user has liked that movie or not
	* You will be comparing the users id against the ids in the movies.likers array with indexOf
* This is an extension from the easier exercise
* View the comments in the app/components/Home.js
