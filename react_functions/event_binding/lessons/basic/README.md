# React Function Lesson

* This lesson shows an example of how to use react functions when events happen on html items.
* You can write all of the javascript functionality within the {}, or you can write a separate function and connect it to the event. There are examples of both of these in the lesson/app/components/Home.js file
* Look for the onMouseOver & onClick...they're written a little bit differently in jQuery right?
