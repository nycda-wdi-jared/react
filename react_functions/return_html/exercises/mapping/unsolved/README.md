# React Return HTML By Mapping Array

* Display The first 3 letters of the persons name in the table as well as if they are less than or equal to 30 or not.
* Look in the /app/components/Home.js file and look for comments
