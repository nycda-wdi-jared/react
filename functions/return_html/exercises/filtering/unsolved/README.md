# React Filter/Mapping/Event Exercise

* Through this exercise, you will learn 
	* how to map items to a materialize select, and then based on what you choose in the select, it will append information about that item when compared against an object
	* how to use the onChange built in react event function	
	* how to use map and filter to display information on the dom
* This exercise combines everything learned in this functions repo
* Please read the instructions in the /app/components/Home.js component

# React Return HTML By Filtering then Mapping Array

* Look at how the array is being filtered first and then mapping two different tables with two different sets of information
* Look in the /app/components/Home.js file and see how html items are being returned via the map function
