# React Return HTML Exercise

* You will have two functions that will return a nav bar and a table
* Use Materialize classes for the nav bar
* Look in the app/components/Home.js file to see comments
