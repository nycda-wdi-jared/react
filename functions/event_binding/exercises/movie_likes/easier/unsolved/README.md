# React Movie Like Exercise

* Look in the app/components/Home.js file for the comments
* In this exercise:
	* When the thumbs up button under the movie is clicked and is black, it will turn blue (meaning that you liked it)
	* When the thumbs up button under the movie is clicked, it will turn black (meaning that you unliked it)
