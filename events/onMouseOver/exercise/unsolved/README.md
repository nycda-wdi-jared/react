# onMouseOver/onMouseLeave event Exercise

* Look for the comments in the Home.js component
* When you hover over the hello world text, the color should change from blue to red.
* Bonus: When you hover off of the hello world text, the color should change back to blue.
