# React on Click Exercise

* Look at the comments in the Home.js component
* When the pikachu picture is clicked, it will alert "You clicked on pikachu"
* When the charizard picture is clicked, it will alert "You clicked on charizard"
