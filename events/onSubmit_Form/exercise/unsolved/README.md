# React Form Submit Exercise

* Check to see if the passwords match
* Change the state of ```matched``` based on whether or not the passwords do match
* Display that state on the page
* Look at the comments in the Home.js component for instructions as well
