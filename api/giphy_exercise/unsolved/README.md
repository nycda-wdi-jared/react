# React Weather Giphy Exercise

* Get 10 Gifs to show on the page after sending a search query into the giphy api
* Look at the comments in the /app/components/Home.js & the /app/api/giphy_api.js
