# React Weather API Exercise

* Look for the solution in the /app/components/Home.js file
* Look at the flow of the application and the console.logs
* Look at how the state of weather is being set when we get the results from the callback and then being appended to the html
* Look at how html is being called in a function and then that function being called in the html
