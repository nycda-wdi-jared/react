...
* When you input a city into the search input, your page will displays the results of that search
* Look for comments in the /app/components/Home.js file
* You will learn how to use form information to put into an api call, and then set the state of the callback, and then append that state to the html
