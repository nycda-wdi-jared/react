# React/React-Router Params Exercise

* Look for comments in Home.js & Character.js components
* Look at the lesson on params. All that is happening here can be figured out through understanding the lesson.
